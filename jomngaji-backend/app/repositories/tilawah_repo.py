...
def get_tilawah_progress(user_id: int, quiz_code: str, pass_threshold: int = 50):
    ...
    best_row = get_best_tilawah_score(user_id, quiz_code)
...
def get_average_tilawah_score(user_id: int) -> float:
    """
    Hitung rata-rata skor tilawah untuk user tertentu langsung dari DB.
